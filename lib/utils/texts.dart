...
const TextSpan INHALTE = TextSpan(
    text:
        """Die Inhalte dieser Website werden mit größtmöglicher Sorgfalt recherchiert und implementiert. Fehler im Bearbeitungsvorgang sind dennoch nicht auszuschließen. Hinweise und Korrekturen senden Sie bitte an den Herausgeber.
...
const TextSpan VERWEISE = TextSpan(
    text:
...
const TextSpan URHEBERRECHT = TextSpan(
    text:
...
const TextSpan DATENSCHUTZ = TextSpan(
    text:
...
const TextSpan RECHTSWIRKSAMKEIT = TextSpan(
    text:
...
const TextSpan BETROFFENENRECHTE = TextSpan(
    text:
...
const TextSpan ARTDERVERARBEITUNG = TextSpan(
    text:
...
const TextSpan RECHTSGRUNDLAGE = TextSpan(
    text:
        """Die Verarbeitung erfolgt gemäß Art. 6 Abs. 1 lit. f DSGVO auf Basis unseres berechtigten Interesses an der Verbesserung der Stabilität und Funktionalität unserer Website.""");

const TextSpan EMPFAENGER = TextSpan(
    text:
        """Empfänger der Daten sind ggf. technische Dienstleister, die für den Betrieb und die Wartung unserer Webseite als Auftragsverarbeiter tätig werden.""");

const TextSpan SPEICHERDAUER = TextSpan(
    text:
        """Die Daten werden gelöscht, sobald diese für den Zweck der Erhebung nicht mehr erforderlich sind. Dies ist für die Daten, die der Bereitstellung der Webseite dienen, grundsätzlich der Fall, wenn die jeweilige Sitzung beendet ist.""");

const TextSpan BEREITSTELLUNG = TextSpan(
    text:
        """Die Bereitstellung der vorgenannten personenbezogenen Daten ist weder gesetzlich noch vertraglich vorgeschrieben. Ohne die IP-Adresse ist jedoch der Dienst und die Funktionsfähigkeit unserer Website nicht gewährleistet. Zudem können einzelne Dienste und Services nicht verfügbar oder eingeschränkt sein. Aus diesem Grund ist ein Widerspruch ausgeschlossen.""");

const TextSpan AENDERUNG = TextSpan(
    text:
